...
export function MobileHeader({ user = { 
  ...
  return (
    <div className="md:hidden bg-white dark:bg-[hsl(var(--space-black-light))] shadow-sm">
      <div className="px-4 py-3 flex items-center justify-between">
        <div className="flex items-center">
          ...
          <h1 className="text-lg font-bold text-gray-800 dark:text-white tracking-tight">SpaceDetect</h1>
        </div>
        
        <div className="flex items-center">
          <button 
            onClick={toggleTheme}
            className="p-1 mr-2 rounded-full text-gray-500 dark:text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 focus:outline-none"
          >
          ...
          <Sheet open={open} onOpenChange={setOpen}>
            ...
            <SheetContent side="right" className="w-[300px] bg-white dark:bg-[hsl(var(--space-black-light))] p-0">
